...
import foundersImage from "../images/media/founders.jpg"
import knowHowImage from "../images/media/know-how.jpg"
import powerfulNetworksImage from "../images/media/powerful-networks.jpg"
import tailoredProductsImage from "../images/media/tailored-products.jpg"
import verticalOwnershipImage from "../images/media/vertical-ownership.jpg"
import {
  utilityCustomUL,
...
const IndexPage = () => {
  return (
    <Layout headerDarkTheme headerIsOverlapping>
      ...
      <PageContainer>
        <SectionWrapper>
          <Media image={tailoredProductsImage}>
          ...
          <Media image={verticalOwnershipImage} flip>
          ...
          <Media image={powerfulNetworksImage} flip>
